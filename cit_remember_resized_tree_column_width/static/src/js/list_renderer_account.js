...
import { AccountMoveUploadListRenderer, AccountMoveListController} from "@account/components/bills_upload/bills_upload";



console.log(">>>>>>>>2")
export class ListColumnWidth extends AccountMoveUploadListRenderer {
    setup(){
        console.log(">>>>>>>>3")
        super.setup();
    }
...
export const AccountMoveUploadListView = {
    ...
    Renderer: ListColumnWidth,
    buttonTemplate: "account.ListView.Buttons",
};

registry.category("views").remove("account_tree");
