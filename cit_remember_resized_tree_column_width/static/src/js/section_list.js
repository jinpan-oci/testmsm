...
import { ListColumnWidth } from "./list_renderer";
...
export class SectionAndNoteListRendererTEST extends ListColumnWidth {
    /**
...
SectionAndNoteListRendererTEST.template = "account.sectionAndNoteListRenderer";

export class SectionAndNoteFieldOne2Many extends X2ManyField {}
SectionAndNoteFieldOne2Many.components = {
    ...X2ManyField.components,
    ListRenderer: SectionAndNoteListRendererTEST,
};
...
// };
registry.category("fields").remove("section_and_note_one2many");
