...
class Attachments(TrelloBase):
    ...
    def from_json(json_obj):
        ...
        previews = [
            AttachmentsPreview.from_json(preview_json)
            for preview_json in json_obj.get("previews")
        ]
    ...
    def __repr__(self):
        return "<Attachments {}>".format(self.name)
...
class AttachmentsPreview:
    ...
    def __repr__(self):
        return "<Attachments Preview {}x{}".format(self.width, self.height)
