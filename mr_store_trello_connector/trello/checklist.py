...
class Checklist(TrelloBase):
    ...
    def delete_checklist_item(self, item_or_name):
        ...
        self.client.fetch_json(
            "/checklists/" + self.id + "/checkItems/" + self.items[ix]["id"],
            http_method="DELETE",
        )
        del self.items[ix]

    def clear(self, items=None):
    ...
    def delete(self):
        ...
        self.client.fetch_json("/checklists/%s" % self.id, http_method="DELETE")
    ...
    def _get_item_index(self, item_or_name):
        ...
        try:
            ix = [
                ...
                if item["name"] == item_or_name or item == item_or_name
            ][0]
            return ix
        except ValueError:
            return None
    ...
    def __repr__(self):
        return force_str("<Checklist %s>" % self.id)
