...
class HerculeControllerUpdate(http.Controller):
    # ---------------------------------------------------------------------------
    # Private methods
    # ---------------------------------------------------------------------------
    ...
    @http.route(
        [
            "/hercule/update_product_and_sol",
            "/hercule/update_product_and_sol/<int:company_id>/<int:order_id>/<int:line_id>",
        ],
        type="http",
        auth="public",
        methods=["POST"],
    ...
    def update_product_and_sol(self, company_id=None, order_id=None, line_id=None, **post):
        ...
        try:
            ...
            # delete old line
            request.env["sale.order.line"].sudo().browse(line_id).unlink()
